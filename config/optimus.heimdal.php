...
return [
    ...
    'formatters' => [
        ...
        SymfonyException\NotFoundHttpException::class => App\Exceptions\NotFoundHttpExceptionFormatter::class,
        Illuminate\Database\Eloquent\ModelNotFoundException::class => App\Exceptions\NotFoundHttpExceptionFormatter::class,
